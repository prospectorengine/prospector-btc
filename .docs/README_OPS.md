...
---
## 5. 🧪 REMOTE PROVING GROUNDS (GITHUB ACTIONS)
...
3. **Mode**: Seleccionar `release` (Vital para tests criptográficos).
4. **Output**: Revisar los logs del paso "Execute Proving Grounds".

*Esta herramienta sustituye la ejecución local cuando se detecta Thermal Throttling o Timeouts.*
