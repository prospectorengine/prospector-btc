...
/*!
 * =================================================================
 * APARATO: SOVEREIGN TELEMETRY CONTRACT (V46.0 - SILICON AWARE)
 * CLASIFICACIÓN: DOMAIN MODELS (ESTRATO L2)
 * RESPONSABILIDAD: DEFINICIÓN DE SEÑALES DE ALTA DENSIDAD Y BIOMETRÍA
 *
 * VISION HIPER-HOLÍSTICA 2026:
 * 1. HARDWARE AWARENESS: Inyección del campo 'supports_avx2' para certificar
 *    la capacidad de aceleración vectorial SIMD en el Dashboard L5.
 * 2. UNIFICACIÓN: Sincroniza el flujo de logs unificados (Panóptico) con
 *    la detección de capacidades de hardware del worker.
 * 3. TYPE SOVEREIGNTY: Sello bit-perfect para la generación de tipos TS
 *    mediante 'typeshare', erradicando el crash de desincronización.
 * 4. NOMINAL PURITY: Mantenimiento de nomenclatura nominal absoluta.
 *
 * # Mathematical Proof (Neural Consistency):
 * Al incluir 'supports_avx2' en el struct base, se garantiza que la
 * serialización bincode/json preserve la integridad de la firma técnica
 * del nodo, permitiendo auditorías de eficiencia algorítmica.
 * =================================================================
 */
...
/// ✅ NIVELACIÓN V46.0: Sincronización con el motor de aceleración SIMD.
#[typeshare]
...
pub struct NodeHardwareMetrics {
    ...
    /// Crítico para la visualización de nodos ELITE en el Panóptico.
