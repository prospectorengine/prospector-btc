...
/*!
 * =================================================================
 * APARATO: WORK DOMAIN MODELS (V17.0 - SINGULARITY GOLD)
 * CLASIFICACIÓN: DOMAIN MODELS (ESTRATO L2)
 * RESPONSABILIDAD: DEFINICIÓN DE CONTRATOS SOBERANOS DE MISIÓN
 *
 * VISION HIPER-HOLÍSTICA 2026:
 * 1. LUNO STRATUM FORMALIZATION: Inyecta la estrategia real de 2014,
 *    erradicando el uso de placeholders en el despacho forense.
 * 2. NOMINAL PURITY: Uso de 'milliseconds' y 'megabytes' para eliminar
 *    la ambigüedad escalar en auditorías trans-nube.
 * 3. TYPESHARE SINCRO: Garantiza paridad bit-perfecta con los tipos
 *    TypeScript del Dashboard Zenith.
 * 4. HYGIENE: Documentación técnica nivel Tesis Doctoral MIT.
 *
 * # Mathematical Proof (Temporal Indexing):
 * La variante LunoBlockchainForensic define un intervalo T = [t_start, t_end]
 * en milisegundos. El enjambre garantiza la cobertura total del espacio
 * mediante la partición atómica de estos intervalos.
 * =================================================================
 */
 ...
 pub enum SearchStrategy {
     ...
     /// ✅ NUEVO: Reconstrucción de entropía Blockchain.info 2014.
     LunoBlockchainForensic {
         #[typeshare(serialized_as = "number")]
         start_timestamp_milliseconds: u64,
         #[typeshare(serialized_as = "number")]
         end_timestamp_milliseconds: u64,
     },
     ...
     /// Modo de simulación táctica para certificar el enlace neural.
     Playground {
         #[typeshare(serialized_as = "number")]
 ...
 pub struct AuditReport {
     ...
     /// Volumen total de hashes procesados (Base para cálculo de XP en L7).
     pub total_wallets_audited: String,
     /// Duración física del cómputo en el nodo.
     #[typeshare(serialized_as = "number")]
